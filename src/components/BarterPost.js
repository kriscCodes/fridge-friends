				...
				<div className="relative z-10 p-8">
					...
					<div className="flex flex-row gap-8">
						...
						<form onSubmit={handleSubmit} className="flex-1 space-y-6">
							...
							{success && (
								<p className="text-green-600 text-sm bg-white p-2 rounded">
									{success}
								</p>
							)}
							...
							<div className="flex justify-end space-x-3 pt-4">
								...
								<button
									type="submit"
									className="px-6 py-3 bg-green-500 text-white font-bold rounded text-xl uppercase hover:bg-green-600"
